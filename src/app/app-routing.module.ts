  ...
  { path:'auth', loadChildren: () => import('./views/pages/auth/auth.module').then(m => m.AuthModule) },
  {
    ...
    children: [
...

      {
        ...
        loadChildren: () => import('./views/pages/quiz-management/quiz-management.module').then(m => m.QuizManagementModule)
      },
      ...
      //   loadChildren: () => import('./views/pages/buyer-management/buyer-management.module').then(m => m.BuyerManagementModule)
      // },
      // {
      //   path: 'apps',
