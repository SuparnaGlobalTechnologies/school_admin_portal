...
import { ApexAxisChartSeries,
  ApexNonAxisChartSeries, ApexGrid, ApexChart, ApexXAxis, ApexYAxis, ApexMarkers, ApexStroke,
  ApexLegend, ApexResponsive, ApexTooltip, ApexFill, ApexDataLabels, ApexPlotOptions, ApexTitleSubtitle } from 'ng-apexcharts';
...
export class DashboardComponent implements OnInit {
  ...
  constructor(private calendar: NgbCalendar) {
    ...
    if (screens.some((item) => item.cl_screen_key === 'Dashboard')) {
